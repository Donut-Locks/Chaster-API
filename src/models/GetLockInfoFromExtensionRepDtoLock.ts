...
import type { ExtensionHomeActionWithPartyId } from './ExtensionHomeActionWithPartyId';
import {
    ExtensionHomeActionWithPartyIdFromJSON,
    ExtensionHomeActionWithPartyIdFromJSONTyped,
    ExtensionHomeActionWithPartyIdToJSON,
} from './ExtensionHomeActionWithPartyId';
...
export interface GetLockInfoFromExtensionRepDtoLock {
     ...
     * @type {Array<ExtensionHomeActionWithPartyId>}
     * @memberof GetLockInfoFromExtensionRepDtoLock
     */
    availableHomeActions: Array<ExtensionHomeActionWithPartyId>;
    /**
...
export function instanceOfGetLockInfoFromExtensionRepDtoLock(value: object): boolean {
    ...
    isInstance = isInstance && "availableHomeActions" in value;
...
export function GetLockInfoFromExtensionRepDtoLockFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetLockInfoFromExtensionRepDtoLock {
    ...
    return {
        ...
        'availableHomeActions': ((json['availableHomeActions'] as Array<any>).map(ExtensionHomeActionWithPartyIdFromJSON)),
...
export function GetLockInfoFromExtensionRepDtoLockToJSON(value?: GetLockInfoFromExtensionRepDtoLock | null): any {
    ...
    return {
        ...
        'availableHomeActions': ((value.availableHomeActions as Array<any>).map(ExtensionHomeActionWithPartyIdToJSON)),
