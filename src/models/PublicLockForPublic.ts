 ...
 * 
 * @export
 * @interface PublicLockForPublic
 */
export interface PublicLockForPublic {
    /**
     * 
     * @type {SharedLockDurationModeEnum}
     * @memberof PublicLockForPublic
     */
...
/**
 * Check if a given object implements the PublicLockForPublic interface.
 */
export function instanceOfPublicLockForPublic(value: object): boolean {
    let isInstance = true;
...
export function PublicLockForPublicFromJSON(json: any): PublicLockForPublic {
    return PublicLockForPublicFromJSONTyped(json, false);
}

export function PublicLockForPublicFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicLockForPublic {
...
export function PublicLockForPublicToJSON(value?: PublicLockForPublic | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
